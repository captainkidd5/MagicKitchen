...
namespace EntityEngine.Classes.ProjectileStuff
{
    internal abstract class Projectile : Collidable
    {
        ...
        {
            MainHullBody = PhysicsManager.CreateCircularHullBody(BodyType.Dynamic, Position, 6f, new List<Category>() { Category.Projectile },
                new List<Category>() { Category.Solid, Category.Grass }, OnCollides, OnSeparates, ignoreGravity: true, blocksLight: true, userData: this);
