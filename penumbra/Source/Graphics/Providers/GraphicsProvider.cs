...
using static Penumbra.PenumbraComponent;
    ...
    internal abstract class GraphicsProvider : IDisposable
    {
        ...
        public virtual void Load(PenumbraEngine engine)
        {
           ...
           // Engine.Window.ClientSizeChanged += ClientSizeChanged;
            PenumbraComponent.VirtualSizeChanged += VirtualSizeChanged;
        ...
        private void VirtualSizeChanged(object sender, VirtualSizeChagnedEventArgs e)
        {
           // Console.WriteLine("test");
            ChangeSize(e.VirtualWidth, e.VirtualHeight);
