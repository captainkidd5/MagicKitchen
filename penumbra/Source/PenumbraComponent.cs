...
namespace Penumbra
{
    ...
    public class PenumbraComponent : DrawableGameComponent
    {
        ...
        public class VirtualSizeChagnedEventArgs : EventArgs
        {
            public int VirtualWidth { get; set; }
            public int VirtualHeight { get; set; }
        }
        public static event EventHandler<VirtualSizeChagnedEventArgs> VirtualSizeChanged;

        public virtual void OnVirtualSizeChanged(VirtualSizeChagnedEventArgs e)
        {
            EventHandler<VirtualSizeChagnedEventArgs> handler = VirtualSizeChanged;
